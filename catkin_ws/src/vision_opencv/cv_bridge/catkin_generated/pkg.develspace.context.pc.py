...
PROJECT_PKG_CONFIG_INCLUDE_DIRS = "/root/catkin_ws/src/vision_opencv/cv_bridge/include;/usr/local/include/opencv4".split(';') if "/root/catkin_ws/src/vision_opencv/cv_bridge/include;/usr/local/include/opencv4" != "" else []
