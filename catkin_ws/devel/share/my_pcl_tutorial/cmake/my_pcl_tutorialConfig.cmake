...
if("TRUE" STREQUAL "TRUE")
  set(my_pcl_tutorial_SOURCE_PREFIX /root/catkin_ws/src/my_pcl_tutorial)
  set(my_pcl_tutorial_DEVEL_PREFIX /root/catkin_ws/devel)
  ...
  set(my_pcl_tutorial_INSTALL_PREFIX /root/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'my_pcl_tutorial' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/catkin_ws/src/my_pcl_tutorial/${idir}'.  ${_report}")
    endif()
